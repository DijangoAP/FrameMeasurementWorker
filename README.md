...
```sh
git clone git@github.com:DijangoAP/FrameMeasurementWorker.git
cd FrameMeasurementWorker
```
...
#### Commit your changes
```sh
git commit -m 'Starting FrameMeasurementWorker'
...
```sh
./mill FrameMeasurementWorker.test
```
